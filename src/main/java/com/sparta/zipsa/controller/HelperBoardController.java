...
public class HelperBoardController {
    ...
    //집사 신청글 조회
    @GetMapping("helperBoard/{helperBoardId}")
    public HelperBoardResponseDto getHelperBoard(@PathVariable Long helperBoardId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        return helperBoardService.getHelperBoard(helperBoardId, userDetails.getUser());
    }
