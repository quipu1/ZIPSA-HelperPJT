...
public class ZipsaApplication {
	...
	public CommandLineRunner test(UserRepository userRepository,
		...
		return (args) -> {
			...
			MatchBoard matchBoard1 = new MatchBoard("저 벌레 잘 잡습니다","user2", board1);
			MatchBoard matchBoard2 = new MatchBoard("벌레 잡기 고수입니다","user3", board1);
			MatchBoard matchBoard3 = new MatchBoard("벌레퇴치 1초컷","user4", board1);
			MatchBoard matchBoard4 = new MatchBoard("청소의왕입니다","user5", board2);
			MatchBoard matchBoard5 = new MatchBoard("화장실청소 고수임!","user6", board2);
			MatchBoard matchBoard6 = new MatchBoard("애기돌보기 마스터입니다","user7", board3);
			MatchBoard matchBoard7 = new MatchBoard("어디든 10초안에 배달가능","user8", board4);
			MatchBoard matchBoard8 = new MatchBoard("조립마스터입니다","user9", board5);
			MatchBoard matchBoard9 = new MatchBoard("총알배송가능","user10", board4);
			MatchBoard matchBoard10 = new MatchBoard("1초만에 조립가능","user1", board5);
